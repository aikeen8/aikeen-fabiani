          ...
          <div className="flex flex-col justify-between flex-1 text-center md:text-left h-auto md:h-40 relative">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3 text-sm font-sans relative z-10 mt-4 md:mt-0 pb-1">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="flex items-center gap-2 px-4 py-2 hover:-translate-y-0.5 shadow-sm transition-all bg-zinc-900 dark:bg-zinc-200 text-white dark:text-zinc-900 rounded-md hover:bg-zinc-800 dark:hover:bg-white"
              >
                <Download size={14} />
                Download CV
              </a>
